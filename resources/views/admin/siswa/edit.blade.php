        ...
        <div class="col-lg-12 col-md-12">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <form class="" action="{{ route('siswa.update', $siswa->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="nisn" class="form-control" required value="{{ $siswa->nisn }}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="nama_siswa" class="form-control" required value="{{ $siswa->nama_siswa }}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="tempat_lahir" class="form-control" required value="{{ $siswa->tempat_lahir }}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="date" name="tanggal_lahir" class="form-control" required value="{{ $siswa->tanggal_lahir }}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="email" class="form-control" required value="{{ $siswa->user->email }}"/>
                            </div>
                        </div>
