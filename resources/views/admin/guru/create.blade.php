        ...
        <div class="col-lg-12">
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <h4 class="mt-0 header-title">Form Tambah Guru</h4>
                    <form class="" action="{{ route('guru.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="nama_guru" class="form-control" required placeholder="Nama Guru"/>
                            </div>
                        </div>
