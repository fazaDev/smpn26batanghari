                ...
                <div class="card-header">
                    <div class="row flex">
                        ...
                        <div class="col-md-2 float-right">
                            <a class="btn btn-primary btn-block" href="{{ route('guru-materi.create') }}">Tambah Materi</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <table id="datatable" class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-info" href="{{ Storage::url($item->file_materi) }}">Download File</a></td>
                                <td class="text-center">
                                    <div class="form-button-action d-flex d-row">
                                        {{-- <a class="btn btn-sm btn-info waves-effect waves-light" href="{{ route('guru-materi.show', $item->id) }}"><i class="fa fa-info-circle"></i></a>
