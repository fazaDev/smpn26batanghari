    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Data Latihan</h4>
                <ol class="breadcrumb">
                ...
                <div class="card-header">
                    <div class="row flex">
                        ...
                        <div class="col-md-2 float-right">
                            <a class="btn btn-primary btn-block" href="{{ route('guru-latihan.create') }}">Tambah Latihan</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="form-button-action d-flex d-row">
                                        <a class="btn btn-sm btn-info waves-effect waves-light" href="{{ route('guru-latihan.show', $item->id) }}"><i class="fa fa-info-circle"></i></a>
